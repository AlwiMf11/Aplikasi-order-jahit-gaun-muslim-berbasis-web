...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Rukamah</strong> Jahit</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="menu_pembeli.php">DAFTAR PAKAIAN</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="hapus_pesanan.php?id_menu=<?php echo $id_menu ?>" class="badge badge-danger">Batal</a>
            </td>
          </tr>
            <?php $nomor++; ?>
      ...
      <form method="POST" action="">
        <a href="menu_pembeli.php" class="btn btn-primary btn-sm">Lihat Pakaian</a>
